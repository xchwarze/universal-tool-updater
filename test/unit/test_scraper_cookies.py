...
def make_scraper():
    return Scraper(force_download=False, use_github_api=False, user_agent='test-agent')
...
def test_collect_cookies_for_does_not_raise_on_duplicate_names():
    ...
    scraper.session.cookies.set('session_id', 'aaa', domain='example.com')
    scraper.session.cookies.set('session_id', 'bbb', domain='unrelated.com')
...
def test_collect_cookies_for_excludes_unrelated_domain():
    scraper = make_scraper()
    scraper.session.cookies.set('token', 'xyz', domain='unrelated.com')
...
def test_collect_cookies_for_exact_host_match():
    scraper = make_scraper()
    scraper.session.cookies.set('token', 'xyz', domain='example.com')
...
def test_collect_cookies_for_host_only_cookie_has_no_domain_restriction():
    ...
    scraper = make_scraper()
    scraper.session.cookies.set('nodomain', 'v')
